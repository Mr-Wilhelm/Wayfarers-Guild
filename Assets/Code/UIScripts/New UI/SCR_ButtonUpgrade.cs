    ...
    private void Start()
    {
        ...
        switch (upgradeName)
        {
            ...
            case "HealthUpgradeButton":
                upgradeDescription = "In The Outer Realms, you're likely to run into more than a couple creatures" +
                    "that want nothing more than to shred you to pieces." +
                    "Toughen up with extra ship health to ensure you make it through, and keep all your packages (and yourselves) in one piece.";
                upgradeCost = 100.0f;
                upgradeImage = GameObject.Find("HealthUpgradeIcon").GetComponent<Image>();
                break;
            case "SonarUpgradeButton":
                upgradeDescription = "OUT OF STOCK! In the vast, unknowable expanses of The Outer Realms, it's imperative to know where you're going." +
            ...
            case "AmmoUpgradeButton":
                upgradeDescription = "OUT OF STOCK! In the event that you find yourself swarmed by horrors with no escape," +
            ...
            case "ScopeUpgradeButton":
                upgradeDescription = "OUT OF STOCK! Sometimes, you just really need to shoot that tiny, far-off nightmare that just won't go away." +
            ...
            case "LightUpgradeButton":
                upgradeDescription = "OUT OF STOCK! This light may be small, but its wide, short-range beam can cut through The Outer Realms' fog like a knife through butter." +
